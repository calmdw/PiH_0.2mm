...
def position_command_error(env: ManagerBasedRLEnv, command_name: str, asset_cfg: SceneEntityCfg) -> torch.Tensor:
    ...
    # print("des_pos_w", torch.abs(curr_pos_w - des_pos_w))
    ...
    # print("is_xy_aligned", is_xy_aligned)
...
def orientation_command_error(env: ManagerBasedRLEnv, command_name: str, asset_cfg: SceneEntityCfg) -> torch.Tensor:
    ...
    # print("des_pos_b", des_quat_b)
    # print("des_pos_w", des_quat_w)
    # print("curr_pos_w", curr_quat_w)
    # print("\n")
    # print("quat_error_magnitude(curr_quat_w, des_quat_w)", quat_error_magnitude(curr_quat_w, des_quat_w))
