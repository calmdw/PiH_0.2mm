...
class UniformPoseCommandPiH(CommandTerm):
    ...
    def __init__(self, cfg: UniformPoseCommandPiHCfg, env: ManagerBasedEnv):
        ...
        self.env_scene_origins = env.scene.env_origins
        ...
        self.pose_command_base = torch.zeros_like(self.pose_command_w)
        self.pose_command_base[:, 3] = 1
        # -- metrics
    ...
    def command(self) -> torch.Tensor:
        ...
        # print("self.pose_command_base", self.pose_command_base)
        return self.pose_command_base
    ...
    def _update_metrics(self):
        ...
        self.pose_command_base = self.pose_command_w.clone().detach()
        self.pose_command_base[:, :3] -= self.env_scene_origins
